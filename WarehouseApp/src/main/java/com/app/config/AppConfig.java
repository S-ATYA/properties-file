...
public class AppConfig implements WebMvcConfigurer{
	...
	public LocalSessionFactoryBean sf() {
		...
		//s.setAnnotatedClasses(Uom.class,Shipment.class,OrderMethod.class,WhUser.class,Document.class,Sale.class,Grn.class,Shipping.class,Purchase.class,Part.class);
		s.setPackagesToScan("com.app");
		return s;
	}
	//SAC
	@Bean
