             ...
             <div class="header bg-primary text-white">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-4">
                      <form:select path="shipmentMode" id="mode" class="form-control">
                   ...
                   <div class="row">
                       ...
                       <div class="col-4">
                           <label for="source">STOCK SOURCE:</label>
                       </div>
                        
                    <div class="col-4">
                      <form:select path="stockSource" id="source" class="form-control">
                  ...
                  <div class="row">
                        ...
                        <div class="col-4">
                           <form:textarea path="description" id="desc" class="form-control"></form:textarea>
                        </div>
                  </div>
